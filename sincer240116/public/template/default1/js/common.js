...
function positionnNav(){
  ...
  var top=$(window).scrollTop()
     if(top>100){$('html').addClass("box-shadow")}
...
fold({
  ...
  content:'.FqaRight dd',
  style:'this',
  hide:'ico icon-arrow-left-copy',
  show:'ico icon-arrow-left-copy'
})
...
$('#Project .swiper-wrapper').lightGallery();
$('.indeximgs').lightGallery();
...
$('.WapNav>ul>li>ul>li>a').click(function(){
      var s=$(this).siblings("ul").length;
     if (s>0) {
        $(this).next('i').click();
    } else{
