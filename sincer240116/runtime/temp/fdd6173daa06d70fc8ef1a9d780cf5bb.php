     ...
     <div class="_header_con _header_con--bottom container" container="100%"> 
      <div class="_head_bottom"> 
       ...
       <nav> 
        ...
        <?php $__DfAbM9jQEr__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__DfAbM9jQEr__) || $__DfAbM9jQEr__ instanceof \think\Collection || $__DfAbM9jQEr__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DfAbM9jQEr__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li>
            ...
            <i class="i_con iconfont iconxiala1"></i> 
                <ul class="nav_ul">
                    <?php $__pDj29Kc8Xm__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__pDj29Kc8Xm__) || $__pDj29Kc8Xm__ instanceof \think\Collection || $__pDj29Kc8Xm__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__pDj29Kc8Xm__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo $son['url']; ?>"><?php echo $son['name']; ?></a>
                        <?php if($son['has_child']): ?>
                            <ul class="nav_ul">
                            <?php $__Y6WPGMqLaz__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__Y6WPGMqLaz__) || $__Y6WPGMqLaz__ instanceof \think\Collection || $__Y6WPGMqLaz__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Y6WPGMqLaz__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sons['url']; ?>"><?php echo $sons['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Y6WPGMqLaz__; ?>
                            </ul> 
                        <?php endif; ?>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__pDj29Kc8Xm__; ?>
                </ul>
            <?php endif; ?>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__DfAbM9jQEr__; ?>
         </ul> 
        </div> 
...
.public_lists_tem_1 .con li{width:100%; }
  ...
  <div class="content_box"> 
   <div class="tem_breadcrumb_1 no_bg_src" id="v61b16a6068aea" module_id="5005" bg_img_url="https://img001.video2b.com/1186/file_01639020662484.jpg" module_type="module"> 
    <div modular-edit="custom"> 
     ...
     <div class="text"> 
      <div class="container"> 
       <div class="text"> 
        <h1 class="top_title">PRODUCTS</h1> 
       </div> 
   ...
   <div class="tem_data_list_1 no_bg_src content-section" id="v61b16a6068af1" module_id="5000" bg_img_url="" module_type="module"> 
    <div class="container"> 
        ...
        <div class="hidden_box"> 
         <div class="list_box"> 
          <ul class="list_one"> 
           <li> 
            <div class="text"> 
             <a href="/products-27874"> 
              <div class="txt "> 
               <span>Zinc Sulphate Heptahydrate ZnSO4.7H2O Fertilizer/Mining Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27875"> 
              <div class="txt "> 
               <span>Zinc Sulphate Monohydrate ZnSO4.H2O Feed /Fertilizer Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27876"> 
              <div class="txt "> 
               <span>Lead Nitrate Pb(NO3)2 Industrial/Mining Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27877"> 
              <div class="txt "> 
               <span>Ferrous Sulphate Heptahydrate FeSO4.7H2O Fertilizer /Mining Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27878"> 
              <div class="txt "> 
               <span>Ferrous Sulphate Monohydrate FeSO4.H2O Feed Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27879"> 
              <div class="txt "> 
               <span>Barium Carbonate 513-77-9</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27880"> 
              <div class="txt "> 
               <span>Manganese Sulphate Monohydrate MnSO4.H2O Industrial /Feed Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27881"> 
              <div class="txt "> 
               <span>Copper Carbonate</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27882"> 
              <div class="txt "> 
               <span>Soda Ash</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27883"> 
              <div class="txt "> 
               <span>Sodium Metabisulphite Na2S2O5 Mining/Food Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27884"> 
              <div class="txt "> 
               <span>Sodium Hydroxide(Caustic Soda) NaOH Industrial/Mining Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-27885"> 
              <div class="txt "> 
               <span>Sodium Isobutyl Xanthate C4H9OC-SNaS2 Mining Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-28376"> 
              <div class="txt "> 
               <span>Ammonium Persulfate (NH4)2S2O8 Industrial/Mining Grade</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-28381"> 
              <div class="txt "> 
               <span>Copper Sulphate Pentahydrate</span> 
              </div> </a> 
            </div> </li> 
           <li> 
            <div class="text"> 
             <a href="/products-28382"> 
              <div class="txt "> 
               <span>Sodium Persulfate Na2S2O8 Industrial/Mining Grade</span> 
              </div> </a> 
            </div> </li> 
          </ul> 
         </div> 
      ...
      <div class="li_nav_left"> 
       <div class="news_details_left_block right_navigation_menus left_con_colors"> 
        ...
        <ul class="right_nav"> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27874">Zinc Sulphate Heptahydrate ZnSO4.7H2O Fertilizer/Mining Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27875">Zinc Sulphate Monohydrate ZnSO4.H2O Feed /Fertilizer Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27876">Lead Nitrate Pb(NO3)2 Industrial/Mining Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27877">Ferrous Sulphate Heptahydrate FeSO4.7H2O Fertilizer /Mining Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27878">Ferrous Sulphate Monohydrate FeSO4.H2O Feed Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27879">Barium Carbonate 513-77-9</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27880">Manganese Sulphate Monohydrate MnSO4.H2O Industrial /Feed Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27881">Copper Carbonate</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27882">Soda Ash</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27883">Sodium Metabisulphite Na2S2O5 Mining/Food Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27884">Sodium Hydroxide(Caustic Soda) NaOH Industrial/Mining Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-27885">Sodium Isobutyl Xanthate C4H9OC-SNaS2 Mining Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-28376">Ammonium Persulfate (NH4)2S2O8 Industrial/Mining Grade</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-28381">Copper Sulphate Pentahydrate</a> 
          </div> </li> 
         <li class=" "> 
          <div class="text                                 "> 
           <a href="/products-28382">Sodium Persulfate Na2S2O8 Industrial/Mining Grade</a> 
          </div> </li> 
        </ul> 
       </div> 
       <div class="sticky_box inquiry_right_sticky_box" btn_show="1"> 
        <div class="sticky_inquiry product_enquiry_box news_details_left_block left_con_colors"> 
         ...
         <form no_form_enovation action="/add-enquiry" class="fl_box_s" onsubmit="return form_submit(this);"> 
          <input type="hidden" name="enquiry_type" id="enquiry_type_v61b16a6068af1" value="0"> 
          <input type="hidden" name="visitlength" id="visitlength_v61b16a6068af1" value="====1705504930===="> 
          <input type="hidden" name="source" id="source_v61b16a6068af1" value="0"> 
          <input type="hidden" name="id" id="id_v61b16a6068af1" value="0"> 
          <ul class="fl_row_s"> 
           <li class="fl12_s"> <label class="enquiry_label"> <input type="text" class="enquiry_inp enquiry_inp_placeholder" title placeholder="Enter your name" autocorrect="off" autocomplete="off" required name="name" id="name_v61b16a6068af1" oninvalid="setCustomValidity('Please fill in this field')" oninput="setCustomValidity('')"> <span class="required_span"><span class="font-color">*</span>Name</span> 
             <div class="required_tips">
              Format error
             </div> </label> </li> 
           <li class="fl12_s"> <label class="enquiry_label"> <input type="text" class="enquiry_inp enquiry_inp_placeholder" title placeholder="Enter your e-mail" autocorrect="off" autocomplete="off" required name="email" id="email_v61b16a6068af1" oninvalid="setCustomValidity('Please fill in this field')" oninput="setCustomValidity('')"> <span class="required_span"><span class="font-color">*</span>E-mail</span> 
             <div class="required_tips">
              Format error
             </div> </label> </li> 
           <li class="fl12_s"> <label class="enquiry_label"> <input type="text" class="enquiry_inp enquiry_inp_placeholder" title placeholder="Enter your phone" autocorrect="off" autocomplete="off" name="phone" id="phone_v61b16a6068af1" oninput="this.value=this.value.replace(/[^\d]/,'');setCustomValidity('')" oninvalid="setCustomValidity('Please fill in this field')"> <span class="required_span"><span class="font-color">*</span>Phone/WhatsApp/Skype</span> 
             <div class="required_tips">
              Format error
             </div> </label> </li> 
           <li class="fl12_s"> <label class="enquiry_label"> <input type="text" class="enquiry_inp enquiry_inp_placeholder" title placeholder="Enter your company name" autocorrect="off" autocomplete="off" name="company" id="company_v61b16a6068af1" oninvalid="setCustomValidity('Please fill in this field')" oninput="setCustomValidity('')"> <span class="required_span"><span class="font-color">*</span>Company Name</span> 
             <div class="required_tips">
              Format error
             </div> </label> </li> 
           <li class="fl12_s"> <label class="enquiry_label textarea_boxs"> <textarea class="enquiry_inp enquiry_inp_placeholder" rows="3" title placeholder="Enter the content of your inquiry" autocorrect="off" autocomplete="off" required name="msg" id="msg_v61b16a6068af1" oninvalid="setCustomValidity('Please fill in this field')" oninput="setCustomValidity('')"></textarea> <span class="required_span"><span class="font-color">*</span>Content</span> 
             <div class="required_tips">
              Format error
             </div> </label> </li> 
          </ul> 
      ...
      <div class="products_ul_box"> 
       <div class="mobile-reverse"> 
        <div class="products_text"> 
         <div class="describe">
          <p>Hunan Sincere Chemicals Co., LTD is a member of Sincere Chemicals (HK) Co., LTD., Our Corporation has built 4 manufacturing plants including sulfate, lead nitrate， and sodium metabisulfite, which is located in Hengyang, Huaihua, and Changde cities in Hunan Province. Our business office is located in Changsha, the capital of Hunan Province.</p>
          <p><br></p>
          <p>Hunan Sincere Chemicals Co., LTD has its own Export License with experienced marketing and service and producing quality chemicals products. We are available for the OEM business model as well.</p>
          <p><br></p>
          <p>We have a strict quality control system. Test every batch of product before we hand it over to customers and keep shipment samples of each batch for customers to recheck. A third-party inspection such as SGS is available.</p>
          <p><br></p>
         </div> 
        </div> 
        <div> 
           ...
           <ul class="pagination"> 
            ...
            <!-- <li class="li_form">
                <form action="" class="pagination_form" onsubmit="return pagination_v61b16a6068af1(this);">
                    ...
                    <input type="hidden" class="list_total" value="122">
